        ...
        <ListboxOptions
          ...
          >
            <li :class="[
              ...
              <HashtagIcon :class="item.color" class="absolute inset-y-2.5 left-6 flex items-center pl-3 h-4 w-8" />
...
import { CheckIcon, ChevronUpDownIcon, HashtagIcon } from '@heroicons/vue/20/solid'
